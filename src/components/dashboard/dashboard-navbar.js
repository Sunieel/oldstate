...
const languages = {
  en: '/avstatic/icons/uk_flag.svg',
  de: '/avstatic/icons/de_flag.svg',
  es: '/avstatic/icons/es_flag.svg'
};
...
const LanguageButton = () => {
  ...
  return (
    <>
    {/* <div style={{ width: '100%' }}>
      <Button>Choosing a Law Firm</Button>
      <Button>Other Services</Button>
      <Button>About Advocat</Button>  
      <Button>My Advocat</Button>
    </div> */}
      <IconButton
