...
const getFeatures = (theme) => ([
  {
    icon: LockIcon,
    image: `/avstatic/home/auth_${theme}.png`,
    items: ['Xero', 'NetSuite', 'other', 'more'],
    subheader: 'Secure management of user accounts',
    title: 'Secure'
  },
  {
    icon: CogIcon,
    ...
    image: `/avstatic/home/flows_${theme}.png`,
    title: 'Management Pages'
  },
  {
    icon: TemplateIcon,
    image: `/avstatic/home/landing_${theme}.png`,
        ...
        >
          ...
          >
            ...
            <Typography
              ...
              variant="subtitle1"
            >
              Convenient management of your products, users, and invoices.
            </Typography>
