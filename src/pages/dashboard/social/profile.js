...
import { AuthConsumer } from '../../../contexts/amplify-context';
...
export const SocialProfile = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Dashboard: Social Profile | Advocat
        </title>
      </Head>
      <Box
        component="main"
      ...
      >
        ...
        <Box sx={{ mt: 5 }}>
          <Container maxWidth="lg">
            ...
            <Divider />
            <Box sx={{ py: 3 }}>
              {currentTab === 'user' && <SocialTimeline profile={profile} />}
              {currentTab === 'firm' && <SocialConnections />}
            </Box>
          </Container>
        </Box>
      </Box>
