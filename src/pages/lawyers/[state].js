...
import {
  Tabs, Box, Tab, Card, InputAdornment, Container, Divider, Typography, TextField
} from '@mui/material';
...
export async function getStaticPaths() {
  ...
  // console.log(states);
  const paths = states.map(stateObj => {
    const state = forUrl(stateObj.short);
    return { params: { state } };
  });
  // console.log(paths);
  return {
